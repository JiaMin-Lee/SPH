...
c
      ...
      do ii=nstart,nb
           Eki_b =Eki_b+0.5*pm(ii)*(up(ii)*up(ii)
     +		                    +wp(ii)*wp(ii))
           Epo_b=Epo_b+g*pm(ii)*zp(ii)
           TE_b=TE_b+TEp(ii)*pm(ii)
      enddo
      ...
      do ii=nbp1,np
           Eki_p =Eki_p+0.5*pm(ii)*(up(ii)*up(ii)
     +		                    +wp(ii)*wp(ii))
           Epo_p=Epo_p+g*pm(ii)*zp(ii)
           TE_p=TE_p+TEp(ii)*pm(ii)
      enddo
